...
## Steps
* [Add any model](https://docs.echo3D.co/quickstart/add-a-3d-model) to the echo3D console.  <br>
* Open the _SimpleAR_ scene in Unity.
* [Set the API key](https://docs.echo3d.co/quickstart/access-the-console) and Entry ID for 'echo3DTestObject' in the Inspector. <br>
